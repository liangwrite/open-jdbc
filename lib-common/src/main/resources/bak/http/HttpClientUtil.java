...
public class HttpClientUtil
{
	...
	public String post(String url, Map<String, String> header, Map<String, String> data) throws Exception
	{		
		//
	...
	public String jsonPost(String url, String json) throws Exception {
